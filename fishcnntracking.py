...
os.system("sudo modprobe msr") # Permite o acesso via root referente as informações do sistema fornecidas pelo Kernel
comandopwr=['sudo','./rapl_plot'] # Executa o script que faz o monitoramento do consumo de energia via PAPI-RAPL
app=subprocess.Popen(args=comandopwr, stdout=open(logarquivo + 'Energia.csv','w'), preexec_fn=os.setpgrp) # Abre um subprocesso de monitoramento do consumo de energia
...
os.system("sudo kill {}".format(pgid))
